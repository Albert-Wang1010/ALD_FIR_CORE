...
# ============================================================================
# Internal Pointers (RTL only - comment out for gate-level)
# ============================================================================
add wave -noupdate -divider "Write Pointers (Binary & Gray)"
add wave -noupdate -radix unsigned /testbench/dut/wptr_bin
add wave -noupdate -radix unsigned /testbench/dut/wptr_gray
add wave -noupdate -divider "Read Pointers (Binary & Gray)"
add wave -noupdate -radix unsigned /testbench/dut/rptr_bin
add wave -noupdate -radix unsigned /testbench/dut/rptr_gray

# ============================================================================
# CDC Synchronizers (RTL only - comment out for gate-level)
# ============================================================================
add wave -noupdate -divider "Write Pointer Synchronization (clk1 -> clk2)"
add wave -noupdate -radix unsigned /testbench/dut/wptr_gray
add wave -noupdate -radix unsigned /testbench/dut/wptr_gray_sync1
add wave -noupdate -radix unsigned /testbench/dut/wptr_gray_sync2
add wave -noupdate -divider "Read Pointer Synchronization (clk2 -> clk1)"
add wave -noupdate -radix unsigned /testbench/dut/rptr_gray
add wave -noupdate -radix unsigned /testbench/dut/rptr_gray_sync1
add wave -noupdate -radix unsigned /testbench/dut/rptr_gray_sync2

# ============================================================================
# FIFO Memory (RTL only - first 8 entries)
# ============================================================================
add wave -noupdate -divider "FIFO Memory Contents"
add wave -noupdate -radix decimal /testbench/dut/mem(0)
add wave -noupdate -radix decimal /testbench/dut/mem(1)
add wave -noupdate -radix decimal /testbench/dut/mem(2)
add wave -noupdate -radix decimal /testbench/dut/mem(3)
add wave -noupdate -radix decimal /testbench/dut/mem(4)
add wave -noupdate -radix decimal /testbench/dut/mem(5)
add wave -noupdate -radix decimal /testbench/dut/mem(6)
add wave -noupdate -radix decimal /testbench/dut/mem(7)
