## Timing constraints for REGFILE post-synthesis PrimeTime analysis
...
# Create clock - REGFILE uses clk2 port
...
if {[sizeof_collection [get_ports rstn]] > 0} {
  ...
  # Relax transition time on reset (it's asynchronous, doesn't matter)
...
# Multi-cycle path for write control during normal operation
# wen signal is stable for multiple cycles during FIR operation
