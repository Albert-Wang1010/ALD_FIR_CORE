...
## Setting files/paths
set verilog_files "../../dc/fir_regfile/fir_regfile.nl.v"
set my_toplevel regfile
...
## Run STA 
###################################################
set rpt_file "./fir_regfile_pt.rpt"
check_timing
...
read_vcd "../../qsim_dc/fir_regfile/testbench.vcd" -strip_path "testbench/dut"
...
write_sdf -context verilog "./fir_regfile.sdf"
